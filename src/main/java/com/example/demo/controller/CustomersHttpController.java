...
@Slf4j
    ...
    class CustomersHttpController {
        ...
        void index(HttpServletResponse response, HttpServletRequest request) throws IOException {
            ...
            html.append("<p>JetBrains激活地址是: <span style='color:red'>")
                    .append(licenseUrl)
                    .append("/");
        ...
        void jrebelLeasesHandler0(HttpServletResponse response, HttpServletRequest request)
            ...
            if (clientRandomness == null || username == null || guid == null) {
                ...
                jrebelSign.toLeaseCreateJson(
                        clientRandomness, guid, offline, validFrom, validUntil);
        ...
        void pingHandler(HttpServletResponse response, HttpServletRequest request)
                throws IOException {
            response.setContentType("text/html; charset=utf-8");
            response.setStatus(HttpServletResponse.SC_OK);
